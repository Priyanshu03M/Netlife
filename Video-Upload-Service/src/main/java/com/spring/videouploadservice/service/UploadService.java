...
public class UploadService {
    ...
    public UploadResponseDto uploadVideoMetadata(UploadVideoRequestDto uploadVideoRequestDto) {
        UploadResponseDto uploadResponseDto = UploadResponseDto.builder().status(UPLOADING).build();
        validateUpload(uploadVideoRequestDto);
        String objectKey = buildObjectKey(uploadVideoRequestDto.getUserId());
    ...
    private void validateUpload(UploadVideoRequestDto uploadVideoRequestDto) {
    ...
    private String buildObjectKey(String userId) {
        ...
        return safeUserID + "/" + UUID.randomUUID();
    }
